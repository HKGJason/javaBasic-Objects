...
class InheritanceTest {
    ...
    void should_be_derived_from_object_class() {
        ...
        // <--start
        final Class<Object> expectedSuperClass = null;
        // --end-->
    ...
    void should_call_super_class_constructor_continued() {
        ...
        // TODO: please modify the following code to pass the test
        // <--start
        final String[] expected = {"DerivedFromSuperClassWithDefaultConstructor.constructor()", "DerivedFromSuperClassWithDefaultConstructor.constructor(int)"};
        // --end-->
    ...
    void should_call_super_class_constructor_more() {
        ...
        // TODO: please modify the following code to pass the test
        // <--start
        final String[] expected = {"SuperClassWithDefaultConstructor.constructor()","DerivedFromSuperClassWithDefaultConstructor.constructor(String)"};
        // --end-->
